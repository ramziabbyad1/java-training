...
public class Surface{
		...
		public Surface getMatrix(){
			return this;
		}
		
		//duplicate data from matrix m into this
		public void copy(Surface s){
			for (int i = 0; i < 4; i++){
				for (int j = 0; j < 4; j++){
					data[i][j] = s.get(i, j);
				}
		...
		public Surface(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j){
