...
public class Trapezoid2{
    ...
    public double[][][] createTrapezoid(int[][] vertices,double[][] tempPhong, Material M,int shapeID,Matrix inverse,Matrix inverseT){
    	...
    	/*System.out.println(a1[0] +" "+ a1[1]+" "+ phonga1[3]);
    	System.out.println(b1[0] +" "+ b1[1]+" "+ phongb1[3]);
    	System.out.println(c1[0] +" "+ c1[1]+" "+ phongc1[3]);*/
    	...
    	System.out.println("B1: "+B1[0] +" "+ B1[1]+" "+ B1[2]);
